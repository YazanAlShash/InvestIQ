"""
InvestIQ — Investment Analysis Dashboard
...
with st.sidebar:
    ...
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px">
        ...
        <span style="font-size:16px;font-weight:600;color:#fff">InvestIQ</span>
    </div>
    <p style="color:rgba(255,255,255,0.3);font-size:11px;margin:0 0 16px 16px">Investment Analysis Dashboard</p>
    """, unsafe_allow_html=True)
    st.divider()
...
<div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
    ...
    <h1 style="margin:0;font-size:22px;font-weight:600;letter-spacing:-0.5px">InvestIQ</h1>
    <span style="color:rgba(255,255,255,0.25);font-size:13px;margin-left:4px">Investment Analysis Dashboard</span>
</div>
""", unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════
with t6:
    st.markdown("## About InvestIQ")
    st.markdown("""
    ### How It Works
    InvestIQ combines 4 data signals to generate scenarios:
...
<div style="margin-top:40px;padding:12px 0;border-top:1px solid rgba(255,255,255,0.05);
    ...
    <span style="font-size:11px;color:rgba(255,255,255,0.2)">DAB401 · St. Clair College</span>
</div>
""",unsafe_allow_html=True)
